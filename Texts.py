...
Не забудь почитать отзывы учеников: https://vk.com/math.university?w=app6326142_-204535334
"""
PHYS731: str = f""", регистрация и оплата на нашей платформе по кнопке ниже.

Как и писали ранее, сумма к оплате {priceOptimum} рублей

После оплаты пришли в этот чат, пожалуйста, скриншот квитанции об оплате, чтобы мы быстрее проверили твой платеж в системе, добавили на платформу и в чат с преподавателем
"""
PHYS732: str = f""", регистрация и оплата на нашей платформе по кнопке ниже.
...
После оплаты пришли в этот чат, пожалуйста, скриншот квитанции об оплате, чтобы мы быстрее проверили твой платеж в системе, добавили на платформу и в чат с преподавателем"""
HYMYA37: str = """
Теперь выбери интересующую тебя тему Химии и органической химии, чтобы получить именно то, что нужно📚
"""
...
"""
EKONOM: str = """
Теперь выбери интересующую тебя тему Экономическому направлению, чтобы получить именно то, что нужно📚
"""
